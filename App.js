...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput placeholder="Enter destination" style={styles.input} value={destination} onChangeText={setDestination} />
      ...
      <TextInput placeholder="Traveler's age" style={styles.input} keyboardType="numeric" value={age} onChangeText={setAge} />
